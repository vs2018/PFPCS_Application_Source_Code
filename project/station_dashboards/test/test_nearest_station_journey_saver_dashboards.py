...
class TestJourneyStation(object):
    ...
    def test_generate_map_data(self, journey):
...
class TestPlace(object):
    ...
    def test_configure_api_data(self, place):
        ...
        assert (place.places["Distance-Value"][0] == 3085.7) or (
            place.places["Distance-Value"][0] == 5614.4
        )
