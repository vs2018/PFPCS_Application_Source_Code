...
class SARIMAXModel(Model):
    ...
    def predict(self):  # [19]
        ...
        print(df, self.error, "sarima prediction engine output")
        return df
...
class PredictionModel:
    def __init__(
        ...
        self.df = df
        print(self.df, "dataframe input vishal predictionmodel")
        self.name = name
    ...
    def evaluate(self):
        if self.sarimax == True:
            ...
            try:
                ...
                print(e, "arima error is not present")
                error_values = [self.rnn_error, self.stat_error]
        print(error_values, "evaluate prediction model vishal")
    ...
    def predict(self):
        ...
        try:
            ...
            print(e, "arima exception error vishal")
        ...
        try:
            ...
            df = stat_model_df
        print(df, "prediction model result")
        return df
...
class ARIMAModel(Model):
    ...
    def fit(self, p, d, q):  # [18]
        print(p, d, q, "ArimaModel fit input")
...
class RNNModel(Model):
    ...
    def get_model(self, scaled_train, scaled_test, n_input, n_features):  # [26]
        ...
        #         model = self.load()
        #     except Exception as e:
        #         print(e,"neural network engine load model error vishal")
    ...
    def update(self, df, fuel, brand, post_code):
        df = df.tail(1)  # [27]
        print(df, "rnn update input vishal")
