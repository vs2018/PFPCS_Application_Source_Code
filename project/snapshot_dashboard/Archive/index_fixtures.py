# Data Source: IBM Watson Discovery API - DiscoveryV1 to extract news articles, URL: https://cloud.ibm.com/apidocs/discovery?code=python
transform_input = [
    (
...
# Data Source: https://media.rac.co.uk/pressreleases
scrape_url_input = [
