...
class TestNaturalLanguage(object):
    ...
    def test_process_predictions(self, text):
        ...
        print(data)
        assert (data["colour"], data["movement"]) == ("#FF0000", "Very likely to go up")
...
class TestRACNewsletter(object):
    ...
    def test_generate_prediction(self, news):
        ...
        print(result)
        assert result["movement"] == "Likely to come down"
...
class TestSentiment(object):
    ...
    def test_render_twitter_trace(self):
        ...
        print(render)
        # Plotly library used https://plot.ly/python/bar-charts/
...
class TestNewsArticle(object):
    ...
    def test_generate_prediction(self, discovery):
        ...
        print(result)
        assert result["movement"] == "Likely to go up"
...
class TestNLUConnection(object):
    def test_connect(self):
        print(NLUConnection())
        assert (
            str(NLUConnection()).split(" ")[0]
            == "<fuel_saver.project.snapshot_app.sentiment.NLUConnection"
        )
...
class TestSnapshotDashboardIntegration(object):
    ...
    def test_discovery_output(self):
        ...
        print(prediction)
        assert prediction["movement"] == "Likely to go up"
    ...
    def test_rac_output(self):
        ...
        print(predictions)
        assert predictions["movement"] == "Likely to come down"
